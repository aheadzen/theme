...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<p><input type="submit" class="auto" value="<?php _e( 'Save Changes', 'buddypress' ) ?>" id="save" name="save" /></p>
...
<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
	...
	<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
		...
		<input type="submit" class="auto" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ) ?>" />
...
<?php if ( bp_is_group_admin_screen( 'delete-group' ) ) : ?>
	...
	<div class="submit">
		<input type="submit" class="auto" disabled="disabled" value="<?php _e( 'Delete Group', 'buddypress' ) ?>" id="delete-group-button" name="delete-group-button" />
	</div>
