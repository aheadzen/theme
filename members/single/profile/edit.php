		...
		<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
			...
			<div<?php bp_field_css_class( 'editfield' ) ?>>
				...
				<?php if ( 'textbox' == bp_get_the_profile_field_type() ) : ?>
					...
					<?php if ( bp_get_the_profile_field_name() == 'Country' )
					{
						$out->show_country_in_profile(bp_get_the_profile_field_input_name(), bp_get_the_profile_field_edit_value());
						echo '<input type="hidden" value="" id="city_string_home" name="city_string_home" />';
